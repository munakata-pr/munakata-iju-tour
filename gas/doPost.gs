 ...
 *  - 第2回は昼食の事前選択がないため、食事・アレルギー項目は送信されない（旧列は空欄で維持）
    ...
    try {
      if (email) {
        ...
        arBody += "\n■ 今後の流れ\n" +
          ...
          "・昼食：大人（保護者）の方には1食1,000円のお弁当をご用意します（ご希望制・当日お支払い／ご持参も可）。\n" +
          "　　　　むなかた子ども大学に参加されるお子様はお弁当を、ご同行の乳幼児のお子様はお食事をご持参ください。\n" +
          "　　　　お弁当のご希望は、参加確定のご連絡時にお伺いします。\n" +
